...
public class MySQLDBConnection implements DBConnection{
	...
	public JSONArray recommendRestaurants(String userId) {
		...
		try {
			...
			Set<String> visitedRestaurants = getVisitedRestaurants(userId);//step 1    read the history table
			Set<String> allCategories = new HashSet<>();// why hashSet? //step 2   dedup by utilizing set 
